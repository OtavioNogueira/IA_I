---
title: Implementar Perceptron (Regra de Hebb) em Python
date: 2026-04-30
priority: high
---

# Implementar Perceptron (Regra de Hebb) em Python
...
- Regra de aprendizado: Hebb (comumente interpretada como regra de correção de erro de Hebb para aprendizado supervisionado, ou regra delta: `w = w + taxa * (d - y) * x` - ou se for o Hebb estrito `w = w + taxa * d * x` quando há erro)
