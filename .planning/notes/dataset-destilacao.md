---
title: Dataset de Destilação de Petróleo
date: 2026-04-30
context: Classificação de duas classes de pureza (C1=-1, C2=+1) a partir de grandezas (x1, x2, x3)
---

# Dataset de Destilação de Petróleo

O dataset original possui 30 padrões para treinar um Perceptron.
